...
<form action="edit_medicine.php" method="post">
	<h2 style="color: #55efc4;">Register/Update medicine</h2>
<div class="txt">
	<input type="text" name="m_name" maxlength="25">
	<span data-placeholder="Name of the Medicine*"></span>
</div>
<div class="txt">
...
<div class="txt">
	<input type="text" name="in_stock" maxlength="3">
	<span data-placeholder="In Stock"></span>
</div>
